...
=======
        local shortopts="$(eval "echo \${cmd${context}_shortopts}")"
        local longopts="$(eval "echo \${cmd${context}_longopts}")"
        local optargs="$(eval "echo \${cmd${context}_optargs}")"
        local subcmds="$(eval "echo \${cmd${context}_subcmds}")"
        local allsubcmds="$(eval "echo \${cmd${context}_allsubcmds}")"
...
<<<<<<< HEAD
                ...
                echo "##-no completions-##"
=======
                if [[ -z "$dashdashseen" ]]; then
                    trace "  completing opts & subcmds (no argtype)"
                    compgen $compgen_opts -W "$shortopts $longopts $subcmds" -- "$word"
                else
                    trace "  completing subcmds (no argtype, dashdash seen)"
                    compgen $compgen_opts -W "$subcmds" -- "$word"
                fi
            elif [[ $argtype == "none" ]]; then
                # We want *no* completions, i.e. some way to get the active
                # 'complete -o default' to not do filename completion. Using
                # a single-space at least works in Bash on Mac OSX 10.11.
                trace "  completing 'none' (hack to attempt to get no completions)"
                echo " "
>>>>>>> 3fcd5ef6f85880b0a38e3a2910ab07264f800c92
...
=======
                potentials=$(complete_$argtype "$word")
...
=======
##     cp FILE /usr/local/etc/bash_completion.d/{{name}}
>>>>>>> 3fcd5ef6f85880b0a38e3a2910ab07264f800c92
##
## or:
##
